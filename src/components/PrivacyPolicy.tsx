...
export const PrivacyPolicy: React.FC = () => {
    React.useEffect(() => {
        ...
        // Force enable scroll for this standalone page
    ...
    return (
        <div className="min-h-screen w-full bg-gray-50 flex flex-col font-sans p-3 py-6 sm:p-6 md:p-12 overflow-x-hidden">
